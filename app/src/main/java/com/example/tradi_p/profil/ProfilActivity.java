package com.example.tradi_p.profil;
...
import static com.example.tradi_p.common.Constants.USERS;
...
import com.example.tradi_p.MainActivity;
...
public class ProfilActivity extends AppCompatActivity {
                    ...
                    public void onComplete(@NonNull @org.jetbrains.annotations.NotNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            userReference.set(hashMap, SetOptions.merge())
                                    ...
                                    .addOnCompleteListener(ProfilActivity.this, new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull @org.jetbrains.annotations.NotNull Task<Void> task) {
                                            finish();
                                        }
    ...
    private void updateNameAndPhoto() {
        ...
        fileRef.putFile(localFileUri)
                .addOnCompleteListener(ProfilActivity.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            fileRef.getDownloadUrl().addOnSuccessListener(ProfilActivity.this, new OnSuccessListener<Uri>() {
                                @Override
            ...
            popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    ...
                    if (id == R.id.mnuModifyAvatar) {
                        ...
                        Toast.makeText(ProfilActivity.this, R.string.image_has_been_deleted, Toast.LENGTH_SHORT).show();
                        deleteAvatar();
                    }
                    return false;
                }
                        ...
                        if (task.isSuccessful()) {
                            ...
                            userReference.set(hashMap, SetOptions.merge())
                                    .addOnCompleteListener(ProfilActivity.this, new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull @org.jetbrains.annotations.NotNull Task<Void> task) {
                                            // Changement du Toast
                                            Toast.makeText(ProfilActivity.this, R.string.avatar_deleted_succesfully, Toast.LENGTH_SHORT).show();
                                        }
                                    });
    ...
    public void btnChangePasswordClick(View v) {
        startActivity(new Intent(ProfilActivity.this, ChangePasswordActivity.class));
    }
